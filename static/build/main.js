...
(function(){
	...
	var Website = function() {
		...
		function heroParralax() {
			var title = document.querySelector('.s-hero h1');
			var bg = document.querySelectorAll('.s-hero .bg')

			function scrollEffects() {
				var scrolled = window.scrollY;
				title.style.opacity = 1-scrolled/400;
				title.style.transform = "translate(0px," + scrolled/10 +"%)";
		...
		function initScrollReveal() {
			...
			var front = document.querySelectorAll('.front-back .border')
			sr.reveal('.s h2, .content',{
				duration: 800,
				origin : 'bottom',
				easing : 'ease',
				scale    : 1,
		...
		function intro() {
			...
			function Init() {
				...
				// add event listener for all the links inside the overlay
				forEach(links, function (index, el) {
					el.addEventListener('click',toggleOverlay)
				});

				forEach(scrollLinks, function (index, el) {
					el.addEventListener('click', handleScroll)
				});


				// Remove default MDL errors
...
},{"./vendor/parallax.js":2,"es6-promise":3,"jquery":4,"material-design-lite":5,"scrollreveal":7,"smoothscroll":8,"vivus":9,"whatwg-fetch":10}],2:[function(require,module,exports){
